...
def create_cov(dim, scale, psi = 2 * np.pi, rng = None):
    ...
    for i in range(dim // 2):
        r = rotation(rng.uniform(low=0, high=psi))
...
def fusion(loader0, loader1, tau = 0):  # TODO: useless now
    ...
    try:
        X1, Y1 = loader1.dataset.data, loader1.dataset.targets
    except:
        X1, Y1 = loader1.dataset.tensors  # useful only when CIFAR10
